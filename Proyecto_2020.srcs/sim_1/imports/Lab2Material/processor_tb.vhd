...
begin
	...
	generic map (                                                 --program2 es chico solo instruc tipo r
	   C_ELF_FILENAME     => "D:\VHDL\Proyecto_2020\program2",    --probar program3 es mas largo y utiliza saltos
      C_MEM_SIZE         => 1024
   )
	port map (
		Clk                => Clk,			 
	...
	generic map (
	   C_ELF_FILENAME     => "D:\VHDL\Proyecto_2020\data",
     C_MEM_SIZE         => 5000
   )	
	port map(
		Clk                => Clk,			 
